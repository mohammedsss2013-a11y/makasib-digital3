...
import { Podcast, Mic, Radio } from "lucide-react";
    ...
    <div className="space-y-10 py-6 dir-rtl">
      <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 border border-slate-800/80 rounded-3xl p-8 sm:p-10 shadow-2xl space-y-4">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          دليل التجهيزات الصوتية والتقاط المرئيات، منصات الاستضافة والتوزيع (Apple & Spotify & RSS)، وحاسبة إنتاج الحلقات.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">دليل هندسة الصوت ومعدات التسجيل</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
            اختبارات استجابة الميكروفونات (Dynamic vs Condenser) وإعداد العزل الصوتي والمعالجة على Audition & Descript.
          </p>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">استراتيجية توزيع واستثمار البودكاست المرئي</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
            كيف تقطع الحلقات الطويلة إلى مقاطع قصيرة منتشرة تعود بالمشتركين والرعايات إلى قناتك الرئيسية.
          </p>
        </div>
      </div>
    </div>
