    ...
    <div className="space-y-10 py-6 dir-rtl">
      <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 border border-slate-800/80 rounded-3xl p-8 sm:p-10 shadow-2xl space-y-4">
        ...
        <h1 className="text-2xl sm:text-4xl font-black text-white leading-tight">
          أخبار وتحليلات الصناعة الرقمية (Industry News)
        </h1>
        <p className="text-slate-300 text-sm leading-relaxed">
          تحليلات اتجاهات المنصات، رصد التغيرات في خوارزميات النشر، والتقارير الاستراتيجية لسوق الإعلام العربي والعالمي.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">رادار الخوارزميات وتحديثات المنصات</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
            متابعة حية للتغيرات الهيكلية في خوارزميات الوصول لعروض X, YouTube, LinkedIn, Instagram.
          </p>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">التقارير التحليلية للاقتصاد الرقمي</h3>
          <p className="text-slate-400 text-xs leading-relaxed">
            دراسات موثوقة حول التحولات في عادات الاستهلاك الرقمي ونمو قطاعات الإعلام الجديد بالمنطقة العربية.
          </p>
        </div>
      </div>
    </div>
