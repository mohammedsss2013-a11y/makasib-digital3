...
export function ArticleDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50" role="dialog" aria-modal="true" aria-label={articleTitle}>
      ...
      <aside className="absolute inset-y-0 left-0 flex w-full max-w-2xl flex-col border-r border-slate-700 bg-slate-900 text-white shadow-2xl motion-safe:animate-[slide-in-left_250ms_ease-out]">
