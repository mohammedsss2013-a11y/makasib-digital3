...
export function CalculatorWorkspace() {
  const [activeSection, setActiveSection] = useState<"finance" | "tech" | "media" | "lifestyle">("finance");
  ...
  return <div className="space-y-6" dir="rtl">
    ...
    {activeSection === "finance" && <section className="space-y-4"><h2 className="border-r-4 border-emerald-500 pr-3 text-xl font-bold text-white">أدوات المال والأعمال</h2><div className="grid grid-cols-1 gap-6 xl:grid-cols-2"><FreelancePricingCalculator /><ContractGenerator /></div></section>}
    {activeSection === "tech" && <section className="space-y-4"><h2 className="border-r-4 border-blue-500 pr-3 text-xl font-bold text-white">أدوات التكنولوجيا</h2><div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
