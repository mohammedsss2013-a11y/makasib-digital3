      ...
      <section className="overflow-hidden rounded-[28px] border border-slate-800/80 bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 p-6 shadow-2xl shadow-slate-950/30 sm:p-8">
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h1 className="text-3xl font-black text-white sm:text-4xl">التكنولوجيا والابتكار</h1>
            <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
              الأدلة والتقنيات التي تحوّل الأجهزة، البيانات، والذكاء الاصطناعي إلى ميزة تنافسية في العمل اليومي والمنتجات الرقمية.
            </p>
          </div>
